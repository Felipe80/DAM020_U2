import 'package:cliente_autos/pages/autos_agregar.dart';
import 'package:cliente_autos/pages/autos_detalle.dart';
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          MaterialPageRoute route =
              MaterialPageRoute(builder: (context) => AutosAgregar());
          Navigator.push(context, route).then((value) {
            setState(() {});
          });
        },
